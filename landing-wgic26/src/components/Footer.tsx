...
const Footer = () => {
    return (
        <footer className="flex flex-col lg:pt-3 lg:pb-1.5 lg:px-8 p-0 gap-0">
            <div className="flex flex-col gap-4 bg-cactus lg:rounded-xl text-cement w-full pl-8 pr-14 md:pl-12 pr-18 py-12 md:py-16">
                <div className="flex flex-col sm:flex-row justify-between items-between gap-16 sm:gap-10">
                    <div className="flex flex-col gap-8 w-1/2 md:w-1/4">
                        ...
                        <div className="text-xs font-light text-white/70">27-30 OCT 2026</div>
                    </div>
                    <div className="flex flex-col md:flex-row gap-20 xl:gap-40">
                        {/* <div className="flex flex-col gap-6 items-start">
                            <div className="uppercase text-xs text-white/40">submissions</div>
                            <div className="flex flex-col gap-6 text-xs">
                                <a href="#" className="hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-potus">Submit paper</a>
                                <a href="#" className="hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-potus">Submit poster</a>
                                <a href="#" className="hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-potus">Become an exhibitor</a>
                                <a href="#" className="hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-potus">Become a partner</a>
                                <a href="#" className="hover:underline hover:underline-offset-8 hover:decoration-2 hover:decoration-potus">Become a sponsors</a>
            ...
            <div className="flex flex-col sm:flex-row py-8 px-8 sm:px-6 sm:py-8 lg:py-6 text-white/70 bg-cactus lg:bg-monstera/60 justify-between gap-2 text-[10px]">
